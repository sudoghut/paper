...
description: "训练9B语言模型像程序员用grep搜代码一样直接用Shell命令搜文档，无需建向量索引，多跳推理任务上超越最强RAG基线20.4%，配套7.6倍加速的并行执行引擎，全部开源"
---
...
| 数据集 | GrepSeek | 最强基线 Search-R1 | 差值 |
|--------|----------|--------------------|------|
| HotpotQA | 0.623 | 0.559 | +11.4% |
| 2WikiMultihopQA | 0.518 | 0.430 | +20.4% |
| NQ | 0.522 | 0.507 | +3.1% |
| MuSiQue | 0.301 | 0.288 | +4.4% |
| TriviaQA | 0.767 | 0.773 | -0.8% |
| PopQA | 0.486 | 0.510 | -4.7% |
| 微平均 F1 | 0.569 | 0.544 | +4.6% |

多跳推理优势显著（+11.4%~+20.4%），单跳/语义改写型略弱（PopQA -4.7%）。
